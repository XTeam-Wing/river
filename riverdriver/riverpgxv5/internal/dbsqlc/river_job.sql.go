...
func (q *Queries) JobDeleteBefore(ctx context.Context, db DBTX, arg *JobDeleteBeforeParams) (pgconn.CommandTag, error) {
	return db.Exec(ctx, jobDeleteBefore,
...
func (q *Queries) JobInsertFullMany(ctx context.Context, db DBTX, arg *JobInsertFullManyParams) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, jobInsertFullMany,
		arg.Args,
		arg.Attempt,
		arg.AttemptedAt,
		arg.CreatedAt,
...
func (q *Queries) JobRetry(ctx context.Context, db DBTX, arg *JobRetryParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, jobRetry, arg.ID, arg.Now)
	var i RiverJob
	err := row.Scan(
		&i.ID,
		&i.Args,
